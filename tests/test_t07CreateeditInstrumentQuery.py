...
class TestT07CreateeditInstrumentQuery():
  ...
  def test_t07CreateeditInstrumentQuery(self):
    ...
    self.driver.find_element(By.NAME, "report_id").send_keys("instrument_query")
    ...
    dropdown.find_element(By.CSS_SELECTOR, "*[value='instrument']").click()
