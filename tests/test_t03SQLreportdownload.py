...
class TestT03SQLreportdownload():
  ...
  def test_t03SQLreportdownload(self):
    ...
    self.driver.execute_script("$.get( window.location.href.replace(\'page=view\',\'page=sql_view\') + \'&download=1\', function(data,status,xhr){if(data.indexOf(\'Bold text\')>-1&&data.indexOf(\'<b>\')==-1&&xhr.getResponseHeader(\'Content-Type\')==\'text/csv; charset=utf-8\'){$(\'body\').append(\'<span data-csv-ok=\"1\"></span>\')};$(\'body\').append(\'<span data-csv=\"1\"></span>\')} )")
