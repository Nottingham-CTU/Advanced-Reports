...
class TestT02SQLreportview():
  ...
  def test_t02SQLreportview(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "#mod-advrep-table tbody td").text == "Normal text"
    assert self.driver.find_element(By.CSS_SELECTOR, "#mod-advrep-table tbody td b").text == "Bold text"
