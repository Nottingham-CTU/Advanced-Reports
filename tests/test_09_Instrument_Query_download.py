...
class TestT09InstrumentQuerydownload():
  ...
  def test_t09InstrumentQuerydownload(self):
    ...
    self.driver.execute_script("$.get( window.location.href.replace(\'page=view\',\'page=instrument_view\') + \'&download=1\', function(data,status,xhr){if(data.indexOf(\'enrollment_arm_1\')>-1&&xhr.getResponseHeader(\'Content-Type\')==\'text/csv; charset=utf-8\'){$(\'body\').append(\'<span data-csv-ok=\"1\"></span>\')};$(\'body\').append(\'<span data-csv=\"1\"></span>\')} )")
