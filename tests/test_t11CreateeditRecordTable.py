...
class TestT11CreateeditRecordTable():
  ...
  def test_t11CreateeditRecordTable(self):
    ...
    elements = self.driver.find_elements(By.CSS_SELECTOR, "select[name=\"report_type\"] option[value=\"recordtbl\"]")
    assert len(elements) > 0
    ...
    self.driver.find_element(By.NAME, "report_id").send_keys("rectbl")
    self.driver.find_element(By.NAME, "report_label").click()
    self.driver.find_element(By.NAME, "report_label").send_keys("Record Table")
    dropdown = self.driver.find_element(By.NAME, "report_type")
    dropdown.find_element(By.CSS_SELECTOR, "*[value='recordtbl']").click()
